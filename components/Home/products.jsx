...
const Products = () => {
    ...
    return (
        <>
            <div className='md:px-16 sm:px-10 lg:px-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3  flex-col'>
            ...
            <div className='w-full my-4 flex justify-center items-center'>
                <button className='border border-[#B88E2F] text-[#B88E2F] px-14 py-3 font-bold'>
                    Show more
                </button>
            </div>
        </>
